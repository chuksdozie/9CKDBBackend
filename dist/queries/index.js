...
async function signUpAdminQuery(payload) {
    return (0, database_1.sql) `INSERT INTO admins ${(0, database_1.sql)(payload, "admin_firstname", "admin_lastname", "admin_phonenumber", "official_email", "password")} RETURNING *`;
}
exports.signUpAdminQuery = signUpAdminQuery;
// verifying the email of the owner
async function verifyOwnerAdminQuery(email) {
    return (0, database_1.sql) `UPDATE admins SET 
...
async function loginAdminQuery(email) {
    return (0, database_1.sql) `SELECT * FROM admins
  WHERE official_email = ${email}
  AND 
  deleted_at IS NULL`;
}
...
async function recentAdminLoginQuery() {
    return (0, database_1.sql) `SELECT 
  admin_firstname,
  admin_lastname,
  role,
  logged_at
...
async function addNewAdminQuery(payload) {
    return (0, database_1.sql) `INSERT INTO admins ${(0, database_1.sql)(payload, "admin_firstname", "admin_lastname", "admin_phonenumber", "official_email", "password", "role")} RETURNING *`;
}
exports.addNewAdminQuery = addNewAdminQuery;
// get admin  details by id
async function getAdminByIdQuery(admin_id) {
    return (0, database_1.sql) `
  SELECT 
...
async function editAdminQuery(id, payload) {
    return (0, database_1.sql) `UPDATE admins SET ${(0, database_1.sql)(payload, "admin_firstname", "admin_lastname", "admin_phonenumber", "official_email", "password", "updated_at")} WHERE id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function editAdminRoleQuery(id, payload) {
    return (0, database_1.sql) `UPDATE admins SET ${(0, database_1.sql)(payload, "admin_firstname", "admin_lastname", "admin_phonenumber", "official_email", "role", "updated_at")} WHERE id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function editAdminPasswordQuery(id, payload) {
    return (0, database_1.sql) `UPDATE admins SET ${(0, database_1.sql)(payload, "password", "updated_at")} WHERE id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function deleteAdminByIdQuery(id, payload) {
    return (0, database_1.sql) `UPDATE admins SET ${(0, database_1.sql)(payload, "deleted_at")} WHERE id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function registerParentQuery(payload) {
    return (0, database_1.sql) `INSERT INTO family ${(0, database_1.sql)(payload, "parent_firstname", "parent_lastname", "parent_phonenumber", "emergency_firstname", "emergency_lastname", "emergency_phonenumber", "parent_email", "home_address", "how_parent_heard_about_us", "city")} RETURNING *`;
}
...
async function editParentQuery(id, payload) {
    return (0, database_1.sql) `UPDATE family SET ${(0, database_1.sql)(payload, "parent_firstname", "parent_lastname", "parent_phonenumber", "emergency_firstname", "emergency_lastname", "emergency_phonenumber", "parent_email", "home_address", "how_parent_heard_about_us", "city", "updated_at", "deleted_at")} WHERE family_id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function deleteParentQuery(id, payload) {
    return (0, database_1.sql) `UPDATE family SET ${(0, database_1.sql)(payload, "deleted_at")} WHERE family_id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function registerChildQuery(payload) {
    return (0, database_1.sql) `INSERT INTO student ${(0, database_1.sql)(payload, "first_name", "last_name", "family_id", "date_of_birth", "sex")} RETURNING *`;
}
...
async function editStudentQuery(id, payload) {
    return (0, database_1.sql) `UPDATE student SET ${(0, database_1.sql)(payload, "first_name", "last_name", "family_id", "date_of_birth", "sex", "updated_at", "deleted_at")} WHERE student_id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function deleteStudentByParentQuery(id, payload) {
    return (0, database_1.sql) `UPDATE student SET ${(0, database_1.sql)(payload, "deleted_at")} WHERE family_id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function deleteStudentQuery(id, payload) {
    return (0, database_1.sql) `UPDATE student SET ${(0, database_1.sql)(payload, "deleted_at")} WHERE student_id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function addNewLocationQuery(payload) {
    return (0, database_1.sql) `INSERT INTO locations ${(0, database_1.sql)(payload, "location_name", "location_address", "location_city")} RETURNING *`;
}
...
async function editLocationByIdQuery(id, payload) {
    return (0, database_1.sql) `UPDATE locations SET ${(0, database_1.sql)(payload, "location_name", "location_address", "location_city", "updated_at")} WHERE location_id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function addNewCourseQuery(payload) {
    return (0, database_1.sql) `INSERT INTO courses_available ${(0, database_1.sql)(payload, "course_name", "course_code")} RETURNING *`;
}
exports.addNewCourseQuery = addNewCourseQuery;
// adding course to a student
async function coursesEnrolledQuery(payload) {
    return (0, database_1.sql) `INSERT INTO courses_enrolled ${(0, database_1.sql)(payload, "student_id", "course_id", "camp_id", "mode", "location_id")} RETURNING *`;
}
...
async function getTotalCoursesEnrolledByStudentQuery(student_id) {
    return (0, database_1.sql) `SELECT COUNT(*) 
    FROM 
    courses_enrolled 
    WHERE
    student_id = ${student_id}
...
async function editCourseQuery(id, payload) {
    return (0, database_1.sql) `UPDATE  courses_available SET ${(0, database_1.sql)(payload, "course_name", "course_code", "updated_at")} WHERE course_id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function editEnrolledCoursesByIdQuery(id, payload) {
    return (0, database_1.sql) `UPDATE courses_enrolled SET ${(0, database_1.sql)(payload, "student_id", "course_id", "camp_id", "mode", "location_id", "updated_at", "deleted_at")} WHERE id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function deleteEnrolledCoursesByIdQuery(id, payload) {
    return (0, database_1.sql) `UPDATE courses_enrolled SET ${(0, database_1.sql)(payload, "updated_at")} WHERE id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
...
async function getCourseByIdQuery(id) {
    return (0, database_1.sql) `SELECT * FROM 
  courses_available 
  WHERE course_id = ${id} 
  AND 
  deleted_at IS NULL`;
...
async function addNewCampQuery(payload) {
    return (0, database_1.sql) `INSERT INTO camps ${(0, database_1.sql)(payload, "camp_name")} RETURNING *`;
}
...
async function editCampQuery(id, payload) {
    return (0, database_1.sql) `UPDATE camps SET ${(0, database_1.sql)(payload, "camp_name", "updated_at")} WHERE id = ${id}
  AND 
  deleted_at IS NULL
  RETURNING *`;
}
